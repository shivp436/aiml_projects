...
def get_estimated_price(location,sqft,bhk,bath, balcony):
    ...
    try:
        ...
        loc_index = __data_columns.index('location_other') # if location not found in columns
...
def load_saved_artifacts():
    ...
    with open("./artifacts/columns.json", "r") as f:
        ...
        __locations = __data_columns[4:]  # first 3 columns are sqft, bath, bhk, balcony
        __locations = [loc.replace('location_', '') for loc in __locations] # replace location_ with empty string
